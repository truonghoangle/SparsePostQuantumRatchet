...
/--
Two `GF16` elements are equal (as structs) if and only if their `value` fields are equal.  This
connects propositional equality of the wrapper to propositional equality of the representation.
-/
