...
Proof that `polyGF2 = X¹⁶ + X¹² + X³ + X + 1` is irreducible over
...
(the bit-encoding of `polyGF2`), and link this computation back to the
algebraic statement using `natToBinaryPoly` and
